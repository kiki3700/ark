...
public interface ICpCodeMgr extends Com4jObject {
  ...
  @VTID(18)
  dashin.cputil.CPE_MARKET_KIND getStockMarketKind(
    java.lang.String bstrCode);
  ...
  @VTID(19)
  dashin.cputil.CPE_CONTROL_KIND getStockControlKind(
    java.lang.String bstrCode);
  ...
  @VTID(20)
  dashin.cputil.CPE_SUPERVISION_KIND getStockSupervisionKind(
    java.lang.String bstrCode);
  ...
  @VTID(21)
  dashin.cputil.CPE_CAPITAL_SIZE getStockCapital(
    java.lang.String bstrCode);
  ...
  @VTID(24)
  dashin.cputil.CPE_KOSPI200_KIND getStockKospi200Kind(
    java.lang.String bstrCode);
  ...
  @VTID(25)
  dashin.cputil.CPE_STOCK_STATUS_KIND getStockStatusKind(
    java.lang.String bstrCode);
  ...
  java.lang.Object getStockListByMarket(
    dashin.cputil.CPE_MARKET_KIND marketKind);
  ...
  @VTID(36)
  dashin.cputil.CPE_KSE_SECTION_KIND getStockSectionKind(
    java.lang.String bstrCode);
  ...
  @VTID(37)
  dashin.cputil.CPE_LAC_KIND getStockLacKind(
    java.lang.String bstrCode);
  ...
  @VTID(48)
  dashin.cputil.CPE_ECT_PARPRICE_CHANGE getStockParPriceChageType(
    java.lang.String bstrName);
  ...
  @VTID(50)
  dashin.cputil.CPE_ECT_VENTURE_KIND getVentureKind(
    java.lang.String bstrName);
  ...
  @VTID(78)
  dashin.cputil.CPE_ECT_OVERHEAT getOverHeating(
    java.lang.String bstrCode);
