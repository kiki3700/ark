...
public interface ICpCalcOptGreeks extends Com4jObject {
   ...
   * </p>
   * @param rhs Mandatory dashin.cputil.CALLPUT_TYPE parameter.
   */

  @DISPID(1) //= 0x1. The runtime will prefer the VTID if present
  @VTID(7)
  void callPutType(
    dashin.cputil.CALLPUT_TYPE rhs);
   ...
   * </p>
   * @param rhs Mandatory dashin.cputil.VOLATILITY_TYPE parameter.
   */

  @DISPID(5) //= 0x5. The runtime will prefer the VTID if present
  @VTID(11)
  void volatilityType(
    dashin.cputil.VOLATILITY_TYPE rhs);
